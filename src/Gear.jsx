...
export default function Gear() {
  return (
    <div className="flex justify-center items-center bg-white w-full">
        <section className="container flex flex-col md:flex-row py-[100px] md:py-[200px] mx-auto max-w-[1110px] px-4 sm:px-6 lg:px-8">
            ...
            <div className="w-full md:w-1/2 h-[588px] max-h-[588px] rounded-2xl bg-cover" style={{ backgroundImage: `url(${person})` }} >
